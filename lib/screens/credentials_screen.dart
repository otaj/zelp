    ...
    try {
      ...
      setState(() {
        ...
        _status = errors.isEmpty
            ? (_fetchKeys ? 'Signed in. Pairing keys loaded.' : 'Signed in.')
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              'Bluetooth pairing keys for Gadgetbridge (shown here to copy or '
              'share), and choose where downloads are saved.',
